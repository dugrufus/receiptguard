...
// [RG:BLOCK HOME.RETURNS_COMBINE_CHIP END]// [RG:BLOCK HOME.PRICE_DROP_SCORE]
"
  Add-Content -LiteralPath C:\Projects\receiptguard\apps\web\src\app\home\page.tsx -Value  -Encoding utf8
  return @{ File=apps/web/src/app/home/page.tsx; Added=True; Reason='appended' }
}

function Ensure-StringsKeys {
  param([Parameter(Mandatory)] [string] apps/web/src/app/home/page.tsx)
  C:\Projects\receiptguard\apps\web\src\app\home\page.tsx = Join-Path C:\Projects\receiptguard apps/web/src/app/home/page.tsx
  if (-not (Test-Path -LiteralPath C:\Projects\receiptguard\apps\web\src\app\home\page.tsx)) { throw "strings.json not found: apps/web/src/app/home/page.tsx" }
   = Get-Content -LiteralPath C:\Projects\receiptguard\apps\web\src\app\home\page.tsx -Raw | ConvertFrom-Json
   = @(
  ...
  if (.Count) {
     | ConvertTo-Json -Depth 100 | Set-Content -LiteralPath C:\Projects\receiptguard\apps\web\src\app\home\page.tsx -Encoding utf8
  }
  return 
}

function Ensure-BlueprintHeuristic {
  C:\Projects\receiptguard\apps\web\src\app\home\page.tsx = Join-Path C:\Projects\receiptguard 'docs/ui/blueprint.md'
  if (-not (Test-Path -LiteralPath C:\Projects\receiptguard\apps\web\src\app\home\page.tsx)) { return False }
  import BottomNav from '../../components/rg/BottomNav';
import { t } from '@/rg/copy'
import Card from '../../components/rg/Card';
import CollapsibleSection from '../../components/rg/CollapsibleSection';
...
// Chip: ""Combine returns"" — link to /return/combine/[merchant]
// NOTE: Hook up to t('combine.title') per copy rules.
// [RG:BLOCK HOME.RETURNS_COMBINE_CHIP END] = Get-Content -LiteralPath C:\Projects\receiptguard\apps\web\src\app\home\page.tsx -Raw
  if (import BottomNav from '../../components/rg/BottomNav';
import { t } from '@/rg/copy'
import Card from '../../components/rg/Card';
import CollapsibleSection from '../../components/rg/CollapsibleSection';
import { t } from '../../rg/i18n/t';
...
// Chip: ""Combine returns"" — link to /return/combine/[merchant]
// NOTE: Hook up to t('combine.title') per copy rules.
// [RG:BLOCK HOME.RETURNS_COMBINE_CHIP END] -match 'Refund Likelihood & Effort Score - Heuristic') { return False }
   = @"
...
Approximate minutes are displayed on the pill.
 = Get-Content -LiteralPath C:\Projects\receiptguard\apps\web\src\app\home\page.tsx -Raw
  if (import BottomNav from '../../components/rg/BottomNav';
import { t } from '@/rg/copy'
import Card from '../../components/rg/Card';
import CollapsibleSection from '../../components/rg/CollapsibleSection';
